...
export default function Usa() {
    const [activeSection, setActiveSection] = useState('why-usa');
    ...
    const sections = [
        { id: 'why-usa', title: 'Why USA?', icon: <MapPin className="w-4 h-4" /> },
        ...
        { id: 'work-opt', title: 'Work & OPT', icon: <MapPin className="w-4 h-4" /> },
    ];
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-red-800 text-white py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center space-x-2 text-sm mb-4 opacity-90">
                        <span>Destinations</span>
                        <span>/</span>
                        <span className="text-brand-red font-semibold">USA</span>
                    </div>
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                        Study in the USA
                    </h1>
                    <p className="text-lg sm:text-xl max-w-3xl mb-8 text-blue-100">
                        Home to the Ivy League, Silicon Valley, and endless academic opportunities in the land of dreams.
                    </p>
                    <button
            ...
            <div className="lg:hidden bg-white border-b border-gray-200 shadow-sm sticky top-[64px] z-40">
                <div className="px-4 py-3 flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-700">Explore USA</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        {/* Section 1: Why USA */}
                        <section id="why-usa" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                <MapPin className="w-6 h-6 text-brand-blue" />
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Why Choose USA?</h2>
                            </div>
                            <img src="https://images.unsplash.com/photo-1550721884-4630d5888d71?q=80&w=1000&auto=format&fit=crop" alt="USA" className="w-full h-64 object-cover rounded-lg mb-6" />
                            <p className="text-gray-700 leading-relaxed mb-4">
                                The USA hosts the largest number of high-ranking universities in the world. Its flexible education system, diverse culture, and massive economy offer unmatched career prospects for international students.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 text-gray-700">
                                <li>Global leadership in innovation and technology</li>
                                <li>Flexible curriculum allowing diverse study combinations</li>
                                <li>Optional Practical Training (OPT) for work experience</li>
                                <li>Extensive research facilities and funding</li>
                            </ul>
                        </section>
                        ...
                        <section id="universities" className="scroll-mt-32">
                            ...
                            <p className="text-gray-700 mb-4">Home to the world's most prestigious Ivy League and research institutions.</p>
                            <div className="grid sm:grid-cols-2 gap-4">
                                {['MIT', 'Harvard University', 'Stanford University', 'UC Berkeley', 'Columbia University'].map((uni, i) => (
                        ...
                        <section id="courses" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                {[
                                    { t: 'CS & STEM', d: 'Silicon Valley demand' },
                                    { t: 'MBA/Finance', d: 'Global business hub' },
                                    { t: 'Entrepreneurship', d: 'Innovation focus' },
                                    { t: 'Psychology', d: 'Top research' }
                                ].map((c, i) => (
                        ...
                        <section id="visa" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Student Visa (F-1)</h2>
                            </div>
                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
                                <p className="text-gray-700 mb-4">Navigating the F-1 visa process requires precision and preparation.</p>
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Form I-20 from University</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">SEVIS Fee Payment</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Visa Interview Preparation</span></div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="cost" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Cost of Education</h2>
                            </div>
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="border p-4 rounded-lg">
                                    <h4 className="font-bold mb-2">Tuition Fees</h4>
                                    <p className="text-sm text-gray-600">$30,000 - $60,000 / year</p>
                                </div>
                                <div className="border p-4 rounded-lg">
                                    <h4 className="font-bold mb-2">Living Costs</h4>
                                    <p className="text-sm text-gray-600">Approx. $15,000 - $25,000 / year</p>
                                </div>
                            </div>
                        </section>

                        {/* Section 6: Work & OPT */}
                        <section id="work-opt" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                <MapPin className="w-6 h-6 text-brand-blue" />
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Work & OPT</h2>
                            </div>
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="bg-brand-blue text-white p-6 rounded-lg">
                                    <h3 className="text-2xl font-bold">1 Year</h3>
                                    <p className="text-sm opacity-90">Standard OPT for all majors</p>
                                </div>
                                <div className="bg-brand-red text-white p-6 rounded-lg">
                                    <h3 className="text-2xl font-bold">3 Years</h3>
                                    <p className="text-sm opacity-90">Total OPT for STEM graduates</p>
                                </div>
                            </div>
                            <p className="mt-4 text-gray-700">Optional Practical Training (OPT) allows graduates to work for 1 to 3 years. International students can also work up to 20 hours per week on-campus.</p>
                        </section>
