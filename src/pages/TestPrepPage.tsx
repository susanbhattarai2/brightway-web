...
// Helper function for scrolling (optional, if you don't have it defined elsewhere)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/contact">
                <Button className="bg-brand-red text-white hover:bg-white/90 px-12 py-6 rounded-full font-semibold text-lg transition-all hover:scale-105">
