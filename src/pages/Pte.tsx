...
export default function Pte() {
    ...
    const sections = [
        { id: 'overview', title: 'Overview', icon: <MapPin className="w-4 h-4" /> },
        { id: 'types', title: 'Types', icon: <GraduationCap className="w-4 h-4" /> },
        { id: 'speaking&writing', title: 'Speaking & Writing', icon: <Briefcase className="w-4 h-4" /> },
        { id: 'reading', title: 'Reading', icon: <Check className="w-4 h-4" /> },
        { id: 'listening', title: 'Listening', icon: <DollarSign className="w-4 h-4" /> },
        { id: 'ptefee', title: 'Pte Fee', icon: <MapPin className="w-4 h-4" /> },
    ];
            ...
            <div className="bg-gradient-to-r from-brand-blue to-blue-900 text-white py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center space-x-2 text-sm mb-4 opacity-90">
                        ...
                        <span>/</span>
                        <span className="text-brand-red font-semibold">PTE</span>
                    </div>
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                        PTE Preparation at Brightway
                    </h1>
                    <p className="text-lg sm:text-xl max-w-3xl mb-8 text-blue-100">
                        Fast-track your study abroad dreams with the computer-based PTE Academic test.
                    </p>
                    <button
