...
export default function Canada() {
    const [activeSection, setActiveSection] = useState('why-canada');
    ...
    const sections = [
        { id: 'why-canada', title: 'Why Canada?', icon: <MapPin className="w-4 h-4" /> },
        ...
        { id: 'work-pr', title: 'Work & PR', icon: <MapPin className="w-4 h-4" /> },
    ];
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-red-800 to-black text-white py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center space-x-2 text-sm mb-4 opacity-90">
                        <span>Destinations</span>
                        <span>/</span>
                        <span className="text-brand-red font-semibold">Canada</span>
                    </div>
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                        Study in Canada
                    </h1>
                    <p className="text-lg sm:text-xl max-w-3xl mb-8 text-red-100">
                        World-class education, diverse culture, and exceptional pathways to permanent residency.
                    </p>
                    <button
            ...
            <div className="lg:hidden bg-white border-b border-gray-200 shadow-sm sticky top-[64px] z-40">
                <div className="px-4 py-3 flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-700">Explore Canada</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        <section id="why-canada" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                <MapPin className="w-6 h-6 text-brand-blue" />
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Why Choose Canada?</h2>
                            </div>
                            <img src="https://images.unsplash.com/photo-1503614472-8c93d56e92ce?q=80&w=1000&auto=format&fit=crop" alt="Canada" className="w-full h-64 object-cover rounded-lg mb-6" />
                            <p className="text-gray-700 leading-relaxed mb-4">
                                Canada is globally recognized for its high-quality education and research. With a welcoming multicultural environment and safe cities, it is a top choice for international students.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 text-gray-700">
                                <li>Top-ranked universities and colleges</li>
                                <li>Affordable tuition and living costs</li>
                                <li>Post-graduation work permit (PGWP) up to 3 years</li>
                                <li>Excellent pathways to Permanent Residency (PR)</li>
                            </ul>
                        </section>
                        ...
                        <section id="universities" className="scroll-mt-32">
                            ...
                            <p className="text-gray-700 mb-4">Home to some of the world's most prestigious research-intensive universities.</p>
                            <div className="grid sm:grid-cols-2 gap-4">
                                {['University of Toronto', 'UBC', 'McGill University', 'University of Waterloo', 'University of Alberta'].map((uni, i) => (
                        ...
                        <section id="courses" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                {[
                                    { t: 'CS & IT', d: 'Tech hub demand' },
                                    { t: 'Business', d: 'Global management' },
                                    { t: 'Healthcare', d: 'High demand' },
                                    { t: 'Engineering', d: 'Diverse specializations' }
                                ].map((c, i) => (
                        ...
                        <section id="visa" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Study Permit Process</h2>
                            </div>
                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
                                <p className="text-gray-700 mb-4">We simplify the application for your Canadian Study Permit.</p>
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Letter of Acceptance (LOA)</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Financial Documents (GIC)</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">CAQ (for Quebec studies)</span></div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="cost" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="border p-4 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-600">CAD $20,000 - $40,000 / year</p>
                                </div>
                                <div className="border p-4 rounded-lg">
                                    <h4 className="font-bold mb-2">Living Costs</h4>
                                    <p className="text-sm text-gray-600">Approx. CAD $15,000 - $20,000 / year</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="work-pr" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="bg-brand-blue text-white p-6 rounded-lg">
                                    ...
                                    <p className="text-sm opacity-90">Off-campus per week</p>
                                </div>
                                <div className="bg-brand-red text-white p-6 rounded-lg">
                                    <h3 className="text-2xl font-bold">Unlimited</h3>
                                    <p className="text-sm opacity-90">During academic breaks</p>
                                </div>
                            </div>
                            <p className="mt-4 text-gray-700">Canada offers one of the best PR pathways for international graduates through the Express Entry and Provincial Nominee Programs (PNP).</p>
                        </section>
