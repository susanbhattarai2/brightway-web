...
export default function Southkorea() {
    const [activeSection, setActiveSection] = useState('why-sk');
    ...
    const sections = [
        { id: 'why-sk', title: 'Why SK?', icon: <MapPin className="w-4 h-4" /> },
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-blue-900 via-indigo-900 to-black text-white py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center space-x-2 text-sm mb-4 opacity-90">
                        <span>Destinations</span>
                        <span>/</span>
                        <span className="text-brand-red font-semibold">South Korea</span>
                    </div>
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                        Study in South Korea
                    </h1>
                    <p className="text-lg sm:text-xl max-w-3xl mb-8 text-blue-100">
                        A global tech giant with a vibrant heart. Discover world-class education amidst the wave of K-culture.
                    </p>
                    <button
            ...
            <div className="lg:hidden bg-white border-b border-gray-200 shadow-sm sticky top-[64px] z-40">
                <div className="px-4 py-3 flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-700">Explore SK</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        {/* Section 1: Why SK */}
                        <section id="why-sk" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                <MapPin className="w-6 h-6 text-brand-blue" />
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Why Choose South Korea?</h2>
                            </div>
                            <img src="https://images.unsplash.com/photo-1517154421773-0529f29ea451?q=80&w=1000&auto=format&fit=crop" alt="South Korea" className="w-full h-64 object-cover rounded-lg mb-6" />
                            <p className="text-gray-700 leading-relaxed mb-4">
                                South Korea is home to some of the most technologically advanced cities and universities in the world. With its global leadership in ICT, automotive, and entertainment industries, it offers unique career pathways.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 text-gray-700">
                                <li>Global center for technology and innovation (Samsung, LG, Hyundai)</li>
                                <li>Highly affordable tuition fees compared to Western nations</li>
                                <li>Intensive cultural experience with the global reach of K-culture</li>
                                <li>Cutting-edge infrastructure and safe student life</li>
                            </ul>
                        </section>
                        ...
                        <section id="universities" className="scroll-mt-32">
                            ...
                            <p className="text-gray-700 mb-4">South Korea's 'SKY' universities and specialized tech institutes are globally recognized.</p>
                            <div className="grid sm:grid-cols-2 gap-4">
                                {['Seoul National University (SNU)', 'KAIST', 'Yonsei University', 'Korea University', 'Pohang University (POSTECH)'].map((uni, i) => (
                        ...
                        <section id="courses" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                {[
                                    { t: 'ICT & Engineering', d: 'World-class tech' },
                                    { t: 'K-Culture/Media', d: 'Global influence' },
                                    { t: 'Fine Arts/Design', d: 'Creative leader' },
                                    { t: 'Business', d: 'Asian economy focus' }
                                ].map((c, i) => (
                        ...
                        <section id="visa" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Student Visa (D-2)</h2>
                            </div>
                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
                                <p className="text-gray-700 mb-4">The D-2 visa is the primary visa for international students in degree programs.</p>
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Certificate of Admission</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Proof of Tuition & Living Funds</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Alien Registration Card (ARC) upon arrival</span></div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="cost" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="border p-4 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-600">$3,000 - $8,000 / semester</p>
                                </div>
                                <div className="border p-4 rounded-lg">
                                    <h4 className="font-bold mb-2">Living Costs</h4>
                                    <p className="text-sm text-gray-600">Approx. $800 - $1,200 / month</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="work-rights" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-1 gap-4">
                                <div className="bg-brand-blue text-white p-6 rounded-lg">
                                    <h3 className="text-2xl font-bold">20-30 Hrs</h3>
                                    <p className="text-sm opacity-90">Per week (varies by level & GPA)</p>
                                </div>
                            </div>
                            <p className="mt-4 text-gray-700">International students can work part-time with permission from the university and the immigration office. This is a great way to gain experience in South Korea's vibrant economy.</p>
                        </section>
