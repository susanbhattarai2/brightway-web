...
export default function Newzealand() {
    const [activeSection, setActiveSection] = useState('why-nz');
    ...
    const sections = [
        { id: 'why-nz', title: 'Why NZ?', icon: <MapPin className="w-4 h-4" /> },
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-emerald-800 via-blue-900 to-black text-white py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center space-x-2 text-sm mb-4 opacity-90">
                        <span>Destinations</span>
                        <span>/</span>
                        <span className="text-brand-red font-semibold">New Zealand</span>
                    </div>
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                        Study in New Zealand
                    </h1>
                    <p className="text-lg sm:text-xl max-w-3xl mb-8 text-emerald-100">
                        High-quality education, unparalleled natural beauty, and a safe, welcoming environment for global learners.
                    </p>
                    <button
            ...
            <div className="lg:hidden bg-white border-b border-gray-200 shadow-sm sticky top-[64px] z-40">
                <div className="px-4 py-3 flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-700">Explore NZ</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        {/* Section 1: Why NZ */}
                        <section id="why-nz" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                <MapPin className="w-6 h-6 text-brand-blue" />
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Why Choose New Zealand?</h2>
                            </div>
                            <img src="https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=1000&auto=format&fit=crop" alt="New Zealand" className="w-full h-64 object-cover rounded-lg mb-6" />
                            <p className="text-gray-700 leading-relaxed mb-4">
                                New Zealand is famous for its high-quality education system. All eight of its public universities are ranked within the top 3% globally. It offers a unique lifestyle with a perfect balance of study and adventure.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 text-gray-700">
                                <li>All 8 universities are globally ranked (QS World Rankings)</li>
                                <li>High level of student support and safety</li>
                                <li>Excellent post-study work opportunities</li>
                                <li>Stunning landscapes and outdoor lifestyle</li>
                            </ul>
                        </section>
                        ...
                        <section id="universities" className="scroll-mt-32">
                            ...
                            <p className="text-gray-700 mb-4">New Zealand is home to 8 world-class public universities and multiple high-quality ITPs.</p>
                            <div className="grid sm:grid-cols-2 gap-4">
                                {['University of Auckland', 'University of Otago', 'Victoria University of Wellington', 'University of Canterbury', 'Massey University'].map((uni, i) => (
                        ...
                        <section id="courses" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                {[
                                    { t: 'Env Science', d: 'Global leadership' },
                                    { t: 'Tourism & Hosp', d: 'Major industry' },
                                    { t: 'IT', d: 'Growing tech sector' },
                                    { t: 'Nursing', d: 'High demand' },
                                    { t: 'Winemaking', d: 'Specialized focus' }
                                ].map((c, i) => (
                        ...
                        <section id="visa" className="scroll-mt-32">
                            ...
                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
                                <p className="text-gray-700 mb-4">The 'Fee Paying Student Visa' process is streamlined for eligible students.</p>
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Offer of Place & Fee Invoice</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Proof of Funds for Tuition & Living</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Health and Character Certificates</span></div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="cost" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="border p-4 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-600">NZD $25,000 - $45,000 / year</p>
                                </div>
                                <div className="border p-4 rounded-lg">
                                    <h4 className="font-bold mb-2">Living Costs</h4>
                                    <p className="text-sm text-gray-600">Approx. NZD $20,000 - $25,000 / year</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="work-rights" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="bg-brand-blue text-white p-6 rounded-lg">
                                    <h3 className="text-2xl font-bold">20 Hrs</h3>
                                    <p className="text-sm opacity-90">Per week during studies</p>
                                </div>
                                <div className="bg-brand-red text-white p-6 rounded-lg">
                                    <h3 className="text-2xl font-bold">1-3 Yrs</h3>
                                    <p className="text-sm opacity-90">Post-study work visa</p>
                                </div>
                            </div>
                            <p className="mt-4 text-gray-700">Studying in New Zealand provides a pathway to work in sectors with skills shortages, and the post-study work visa allows for career establishment.</p>
                        </section>
