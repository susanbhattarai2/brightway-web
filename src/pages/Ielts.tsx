...
export default function Ielts() {
    // We still track activeSection for highlighting the tab, but not for hiding content
    const [activeSection, setActiveSection] = useState('why-australia');
    ...
    // Define Sections with IDs for scrolling
    const sections = [
        { id: 'ielts', title: 'IELTS', icon: <MapPin className="w-4 h-4" /> },
        { id: 'listening', title: 'Listening', icon: <GraduationCap className="w-4 h-4" /> },
        { id: 'reading', title: 'Reading', icon: <Briefcase className="w-4 h-4" /> },
        { id: 'writing', title: 'Writing', icon: <Check className="w-4 h-4" /> },
        { id: 'speaking', title: 'Speaking', icon: <DollarSign className="w-4 h-4" /> },
        { id: 'ieltsfee', title: 'Ielts Fee', icon: <MapPin className="w-4 h-4" /> },
    ];

    // Handle Smooth Scroll to ID
    ...
    // Scroll Spy: Highlight active tab on scroll
    useEffect(() => {
        const handleScroll = () => {
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="bg-gradient-to-r from-brand-blue to-blue-900 text-white py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center space-x-2 text-sm mb-4 opacity-90">
                        ...
                        <span>/</span>
                        <span className="text-brand-red font-semibold">IELTS</span>
                    </div>
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                        Master IELTS With Brightway
                    </h1>
                    <p className="text-lg sm:text-xl max-w-3xl mb-8 text-blue-100">
                        Join Nepal's most trusted IELTS coaching center. Expert guidance, comprehensive study materials, and a proven track record.
                    </p>
                    <button
            ...
            <div className="lg:hidden bg-white border-b border-gray-200 shadow-sm sticky top-[64px] z-40">
                <div className="px-4 py-3 flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-700">Explore Australia</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        {/* Section 1: Why Australia */}
                        <section id="why-australia" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                <MapPin className="w-6 h-6 text-brand-blue" />
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Why Choose Australia?</h2>
                            </div>
                            <img src="https://images.unsplash.com/photo-1523482580672-f109ba8cb9be?q=80&w=1000&auto=format&fit=crop" alt="Australia" className="w-full h-64 object-cover rounded-lg mb-6" />
                            <p className="text-gray-700 leading-relaxed mb-4">
                                Australia offers a unique blend of high-quality education, safe living environment, and diverse culture. With 7 universities in the global top 100, it is a hub for innovation and research.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 text-gray-700">
                                <li>High quality of life and safe cities</li>
                                <li>Post-study work rights up to 4-6 years</li>
                                <li>Diverse culture and welcoming communities</li>
                            </ul>
                        </section>
                        ...
                        <section id="universities" className="scroll-mt-32">
                            ...
                            <p className="text-gray-700 mb-4">Home to the prestigious "Group of Eight" (Go8) including University of Melbourne, UNSW, and University of Sydney.</p>
                            <div className="grid sm:grid-cols-2 gap-4">
                                {['University of Melbourne', 'University of Sydney', 'UNSW Sydney', 'Monash University'].map((uni, i) => (
                        ...
                        <section id="courses" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                {[
                                    { t: 'IT & CS', d: 'High demand' },
                                    { t: 'Engineering', d: 'Global recognition' },
                                    { t: 'Nursing', d: 'PR pathway' }
                                ].map((c, i) => (
                        ...
                        <section id="visa" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Student Visa (Subclass 500)</h2>
                            </div>
                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
                                <p className="text-gray-700 mb-4">We assist with CoE, OSHC, GS Statement, and financial documents.</p>
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Offer Letter & CoE</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Health Cover (OSHC)</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Genuine Student Statement</span></div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="cost" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="border p-4 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-600">AUD $20,000 - $45,000 / year</p>
                                </div>
                                <div className="border p-4 rounded-lg">
                                    <h4 className="font-bold mb-2">Living Costs</h4>
                                    <p className="text-sm text-gray-600">Approx. AUD $24,505 / year</p>
                                </div>
                            </div>
                        </section>

                        {/* Section 6: Work & PR */}
                        <section id="work-pr" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                <MapPin className="w-6 h-6 text-brand-blue" />
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Work Rights & PR</h2>
                            </div>
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="bg-brand-blue text-white p-6 rounded-lg">
                                    <h3 className="text-2xl font-bold">48 Hrs</h3>
                                    <p className="text-sm opacity-90">Per fortnight during semesters</p>
                                </div>
                                <div className="bg-brand-red text-white p-6 rounded-lg">
                                    <h3 className="text-2xl font-bold">Unlimited</h3>
                                    <p className="text-sm opacity-90">During course breaks</p>
                                </div>
                            </div>
                            <p className="mt-4 text-gray-700">Post-study work visa (Subclass 485) allows graduates to stay for 2-4 years.</p>
                        </section>
