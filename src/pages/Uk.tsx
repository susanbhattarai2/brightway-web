...
export default function Uk() {
    const [activeSection, setActiveSection] = useState('why-uk');
    ...
    const sections = [
        { id: 'why-uk', title: 'Why UK?', icon: <MapPin className="w-4 h-4" /> },
        ...
        { id: 'work-pr', title: 'Work Rights', icon: <MapPin className="w-4 h-4" /> },
    ];
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-blue-900 to-red-900 text-white py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center space-x-2 text-sm mb-4 opacity-90">
                        <span>Destinations</span>
                        <span>/</span>
                        <span className="text-brand-red font-semibold">UK</span>
                    </div>
                    <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                        Study in the UK
                    </h1>
                    <p className="text-lg sm:text-xl max-w-3xl mb-8 text-blue-100">
                        World-class heritage, intensive degree programs, and a global gateway for your career.
                    </p>
                    <button
            ...
            <div className="lg:hidden bg-white border-b border-gray-200 shadow-sm sticky top-[64px] z-40">
                <div className="px-4 py-3 flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-700">Explore UK</span>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-16">
                        ...
                        {/* Section 1: Why UK */}
                        <section id="why-uk" className="scroll-mt-32">
                            <div className="flex items-center gap-3 mb-4">
                                <MapPin className="w-6 h-6 text-brand-blue" />
                                <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Why Choose UK?</h2>
                            </div>
                            <img src="https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?q=80&w=1000&auto=format&fit=crop" alt="UK" className="w-full h-64 object-cover rounded-lg mb-6" />
                            <p className="text-gray-700 leading-relaxed mb-4">
                                The UK education system is globally renowned for its academic excellence. With shorter, more focused programs, students can complete their degrees faster and enter the workforce sooner.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 text-gray-700">
                                <li>Intensive 1-year Masters programs</li>
                                <li>Global heritage and academic tradition</li>
                                <li>Great cultural diversity and vibrant student life</li>
                                <li>2-year Graduate Route post-study work visa</li>
                            </ul>
                        </section>
                        ...
                        <section id="universities" className="scroll-mt-32">
                            ...
                            <p className="text-gray-700 mb-4">Home to some of the oldest and most prestigious universities in the world.</p>
                            <div className="grid sm:grid-cols-2 gap-4">
                                {['University of Oxford', 'University of Cambridge', 'Imperial College London', 'UCL', 'University of Manchester'].map((uni, i) => (
                        ...
                        <section id="courses" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                {[
                                    { t: 'MBA & Business', d: 'Global recognition' },
                                    { t: 'Data Science', d: 'High-tech demand' },
                                    { t: 'Law', d: 'Historical excellence' },
                                    { t: 'Fashion', d: 'Creative leader' }
                                ].map((c, i) => (
                        ...
                        <section id="visa" className="scroll-mt-32">
                            ...
                            <div className="bg-blue-50 p-6 rounded-lg border border-blue-100">
                                <p className="text-gray-700 mb-4">We guide you through the Tier 4 Student Visa requirements.</p>
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Confirmation of Acceptance (CAS)</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Immigration Health Surcharge (IHS)</span></div>
                                    <div className="flex items-center gap-2"><div className="w-2 h-2 bg-brand-blue rounded-full"></div><span className="text-sm text-gray-700">Financial Capability Evidence</span></div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="cost" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="border p-4 rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-600">£12,000 - £35,000 / year</p>
                                </div>
                                <div className="border p-4 rounded-lg">
                                    <h4 className="font-bold mb-2">Living Costs</h4>
                                    <p className="text-sm text-gray-600">Approx. £12,000 - £15,000 / year</p>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="work-pr" className="scroll-mt-32">
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="bg-brand-blue text-white p-6 rounded-lg">
                                    ...
                                    <p className="text-sm opacity-90">Per week during term</p>
                                </div>
                                <div className="bg-brand-red text-white p-6 rounded-lg">
                                    <h3 className="text-2xl font-bold">Full Time</h3>
                                    <p className="text-sm opacity-90">During official vacations</p>
                                </div>
                            </div>
                            <p className="mt-4 text-gray-700">The Graduate Route allows students to stay and work in the UK for 2 years (3 years for PhD) after successfully completing their course.</p>
                        </section>
